...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Create feature directory structure.")
    parser.add_argument("-b", "--base_directory", required=True, help="Base directory for the project.")
    parser.add_argument("-f", "--feature_name", required=True, help="Name of the feature.")
