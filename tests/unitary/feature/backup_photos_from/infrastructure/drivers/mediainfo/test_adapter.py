...
from src.feature.backup_files_from.infrastructure.drivers.mediainfo.adapter import MediaInfoForVideoAdapter
...
def test_send_message(mock_create_message):
    ...
    adapter = MediaInfoForVideoAdapter("test.mp4")
    date = adapter.extractDate()
